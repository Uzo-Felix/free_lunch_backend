...
1. Clone the repo `git clone https://github.com/Uzo-Felix/free_lunch_backend`.
2. Open your terminal & set the origin branch: `git remote add origin https://github.com/Uzo-Felix/free_lunch_backend.web.git`
